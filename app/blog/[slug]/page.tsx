  ...
  return (
    <div className="min-h-screen flex flex-col bg-luxury-offwhite dark:bg-luxury-black">
      ...
      <main className="flex-grow max-w-6xl w-full mx-auto px-4 sm:px-6 lg:px-8 pt-36 pb-16">
        ...
        <Link 
          href="/blog" 
          className="inline-flex items-center text-xs tracking-wider text-gray-500 hover:text-luxury-gold transition-colors duration-200 mb-8 uppercase font-semibold"
        >
        ...
        <article className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <h1 className="text-3xl sm:text-5xl font-serif text-luxury-black dark:text-white leading-tight tracking-wide">
              {post.title}
            </h1>
            
            <div className="flex flex-wrap items-center gap-6 pt-2 border-b border-gray-150 dark:border-zinc-800/80 pb-6 text-xs text-gray-400">
          ...
          {/* Featured Image */}
          <div className="aspect-[21/9] bg-white rounded-2xl overflow-hidden border border-gray-100 dark:border-zinc-800 shadow-sm relative select-none">
            <img 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 pt-8">
            ...
            <div className="hidden lg:block space-y-8 select-none">
              ...
              {/* Table of Contents */}
              {headings.length > 0 && (
                <div className="bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800/80 p-5 rounded-2xl space-y-4">
              ...
              <div className="bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800/80 p-5 rounded-2xl space-y-4">
                ...
                <div className="flex space-x-3 text-gray-400">
                  <button className="p-2 border border-gray-100 dark:border-zinc-800 rounded-lg hover:text-luxury-gold duration-150 cursor-pointer" title="Share on Twitter">
                    <Share2 className="w-4 h-4" />
                  </button>
                  <button className="p-2 border border-gray-100 dark:border-zinc-800 rounded-lg hover:text-luxury-gold duration-150 cursor-pointer" title="Copy Link">
            ...
            <div className="lg:col-span-3 space-y-6">
              <div className="prose prose-zinc dark:prose-invert max-w-none text-sm text-gray-500 dark:text-gray-400 leading-relaxed font-sans space-y-6">
                {paragraphs.map((para: string, idx: number) => {
                  ...
                  if (isSubheader) {
                    return (
                      <h3 key={idx} className="font-serif text-lg text-luxury-black dark:text-white uppercase tracking-wide pt-4 pb-2 border-b border-gray-50 dark:border-zinc-850">
                        {para}
                      </h3>
                    );
                  }
                  ...
                  return (
                    <p 
                      key={idx} 
                      className={isLead ? 'text-base font-serif italic text-luxury-charcoal dark:text-luxury-beige border-l-2 border-luxury-gold pl-4 py-1 leading-relaxed' : ''}
                    >
                      {para}
                    </p>
                  );
                ...
                <div className="flex items-center space-x-2.5 pt-8 border-t border-gray-100 dark:border-zinc-850 mt-10">
                  ...
                  <div className="flex flex-wrap gap-2 text-[10px] uppercase font-bold tracking-widest text-gray-400">
                    {post.tags.map((tg: string) => (
                      <span key={tg} className="bg-gray-150 dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800/80 px-2.5 py-1 rounded-md">
                        {tg}
                      </span>
                    ))}
                  </div>
        ...
        {related && related.length > 0 && (
          <section className="mt-24 border-t border-gray-100 dark:border-zinc-900 pt-16">
            <h3 className="font-serif text-2xl text-luxury-black dark:text-white uppercase tracking-wider mb-10 text-center select-none">
              Chronicles Continues
            </h3>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {related.map((item) => (
                <div key={item.slug} className="bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800/60 rounded-2xl overflow-hidden group hover:shadow-md transition-shadow duration-300">
